...
Repeats were annotated with the [Ensembl Genomes repeat feature pipeline](https://ensemblgenomes.org/info/data/repeat_features). There are: 982,556 Low complexity (Dust) features, covering 109 Mb (15.5% of the genome); 341,667 RepeatMasker features (with the nrTEplants library), covering 326 Mb (46.4% of the genome); 218,553 RepeatMasker features (with the RepBase library), covering 87 Mb (12.4% of the genome); 421,645 Tandem repeats (TRF) features, covering 46 Mb (6.5% of the genome).