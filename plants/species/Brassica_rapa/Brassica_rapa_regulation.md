...
-   Arabidopsis coding sequences aligned using BLAT:
    -   Alignment
        [parameters](https://genome.ucsc.edu/goldenPath/help/blatSpec.html):
        minmatch(2), minscore(30), min identity(80), maxGap(2), evalue
        threshold(1e^-5^).
    -   Dataset: 33,410 Arabidopsis [TAIR](https://www.arabidopsis.org/)
        v9 coding sequences.
    -   External links: [AtEnsembl](https://atensembl.arabidopsis.info)
        transcripts.
-   A 95k [Brassica
    UniGene](https://brassica.bbsrc.ac.uk/array_info.html) set generated
...
-   A 135k [Brassica
    UniGene](https://www.brassica.info/resource/transcriptomics/ExonArrayInformation_Jan2010b.pdf)
...
-   *B. rapa* BAC end sequences aligned using Decypher tera-blastn:
    ...
    -   Dataset: 196,837 *B. rapa* BAC end sequences obtained from
        GenBank 5-Aug-2010.
    -   External links: [GenBank](https://www.ncbi.nlm.nih.gov).
