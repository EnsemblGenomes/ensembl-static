...
Repeats were annotated with the [Ensembl Genomes repeat feature pipeline](https://plants.ensembl.org/info/genome/annotation/repeat_features.html).There are: 785658 Low complexity (Dust) features, covering 23 Mb (0.8% of the genome); 193205 RepeatMasker features (with the nrTEplants library), covering 65 Mb (2.4% of the genome); 367896 Tandem repeats (TRF) features, covering 60 Mb (2.2% of the genome); Repeat Detector repeats length 1.84Gb (67.9% of the genome).
