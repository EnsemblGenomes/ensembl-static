...
([RAP-DB](https://rapdb.dna.affrc.go.jp)). The most recent update was
from its 1st September 2022 release. This version corrected gene models
with manual curation, also deprecated some bad models. Feature annotation and comparative
analysis pipelines have been run and variations have been projected from
the old annotation to the new one.

[MSU-7](https://rice.plantbiology.msu.edu/home_overview.shtml) gene
models were also loaded for visual comparison to the IRGSP set. Cross
references between the two gene sets provided by
[RAP-DB](https://rapdb.dna.affrc.go.jp) allow searching and querying
