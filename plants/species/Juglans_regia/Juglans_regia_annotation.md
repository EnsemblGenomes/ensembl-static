...
Repeated sequences were annotated with the Repeat Detector and the [Ensembl Genomes repeat feature pipeline](/info/genome/annotation/repeat_features.html).There are: 1215333 Low complexity (Dust) features, covering 52 Mb (9.0% of the genome); 213484 RepeatMasker features (with the nrTEplants library), covering 79 Mb (13.8% of the genome); 473692 Tandem repeats (TRF) features, covering 37 Mb (6.5% of the genome).
